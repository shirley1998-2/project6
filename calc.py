...
button_frame = Frame(window, bg="light blue")
button_frame.pack()
equation = StringVar()
...
button7 = Button(button_frame,text='7', font=('times new roman', 12), relief='ridge',
                 bd=1, bg='#fff7e6', width=8, height=3, command=lambda: press(7))

button8 = Button(button_frame,text='8', font=('times new roman', 12), relief='ridge',
                 bd=1, bg='#fff7e6', width=8, height=3, command=lambda: press(8))

button9 = Button(button_frame,text='9', font=('times new roman', 12), relief='ridge',
                 bd=1, bg='#fff7e6', width=8, height=3, command=lambda: press(9))

multilpy = Button(button_frame,text='*', font=('times new roman', 12), relief='ridge',
                 bd=1, bg='#fff7e6', width=8, height=3, command=lambda: press('*'))

button0 = Button(button_frame, text='0', font=('times new roman', 12), relief='ridge',
                 bd=1, bg='#fff7e6', width=8, height=3, command=lambda: press(0))
...
clear = Button(button_frame, text='C', font=('times new roman', 12), relief='ridge',
                 bd=1, bg='#fff7e6', width=8, height=3, command=clear)
...
equal = Button(button_frame,text='=', font=('times new roman', 12), relief='ridge',
                 bd=1, bg='#fff7e6', width=8, height=3, command=equalpress)
